    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Fresh Vegetables", path: '/', icon: null },
                { text: "Seasonal Fruits", path: '/', icon: null },
                { text: "Organic Greens", path: '/', icon: null },
                { text: "Herbs & Spices", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91-9861-245-732", path: '/', icon: PhoneIcon },
                { text: "support@freshkart.in", path: '/', icon: MailIcon },
                { text: "Baripada, Mayurbhanj, Odisha, 757001", path: '/', icon: MapPinIcon }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">Fresh</span>Kart<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">
                            Welcome to <b>FreshKart</b> — your trusted source for farm-fresh vegetables, organic produce, and locally grown fruits.
                            We connect you directly to farmers for a healthier tomorrow.
                        </p>
                ...
                <p className="py-4 text-sm text-slate-500 text-center">
                    Copyright © 2025 FreshKart. All Rights Reserved.
                </p>
            </div>
        </footer>
    );
